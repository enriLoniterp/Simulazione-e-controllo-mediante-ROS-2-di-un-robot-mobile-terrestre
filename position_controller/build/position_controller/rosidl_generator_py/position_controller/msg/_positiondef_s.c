...
bool position_controller__msg__positiondef__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "position_controller.msg._positiondef.Positiondef",
        full_classname_dest, 48) == 0);
  }
  position_controller__msg__Positiondef * ros_message = _ros_message;
  {  // posx
  ...
  {  // postheta
    PyObject * field = PyObject_GetAttrString(_pymsg, "postheta");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->postheta = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Positiondef */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("position_controller.msg._positiondef");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Positiondef");
  ...
  {  // postheta
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->postheta);
    {
      int rc = PyObject_SetAttrString(_pymessage, "postheta", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
